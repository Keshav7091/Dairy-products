      ...
      <div className="container mx-auto px-6 lg:px-12 xl:px-20 flex flex-col md:flex-row items-start gap-10">
        ...
        <div className="md:w-1/2 order-2 md:order-1">
          ...
          <p className="text-gray-600 mb-6 leading-relaxed">
            ...
            products crafted with precision and care. Our manufacturing processes 
            follow the best industry practices, ensuring freshness, consistency, 
            and premium quality in every batch.
          </p>
          <p className="text-gray-600 mb-6 leading-relaxed">
          ...
          <ul className="space-y-4 text-gray-700 text-lg">
            ...
            <li className="flex items-start">
              ...
              <span>Premium quality products using carefully sourced ingredients</span>
            </li>
            <li className="flex items-start">
              <span className="text-green-600 text-xl mr-3 font-bold mt-0.5">
                ✅
              </span>{" "}
              <span>Strict adherence to modern manufacturing best practices</span>
            </li>
            <li className="flex items-start">
              <span className="text-green-600 text-xl mr-3 font-bold mt-0.5">
                ✅
              </span>{" "}
              <span>Consistent taste, freshness, and hygiene in every batch</span>
            </li>
            <li className="flex items-start">
              <span className="text-green-600 text-xl mr-3 font-bold mt-0.5">
                ✅
              </span>{" "}
              <span>Supporting ethical sourcing and responsible production</span>
            </li>
            <li className="flex items-start">
              <span className="text-green-600 text-xl mr-3 font-bold mt-0.5">
                ✅
              </span>{" "}
              <span>Aligned with modern food safety and EU standards</span>
            </li>
          </ul>
        ...
        <div className="md:w-2/3 mt-10 md:mt-0 order-1 md:order-2 flex flex-col">
          <img
            src="/home/06.jfif"
