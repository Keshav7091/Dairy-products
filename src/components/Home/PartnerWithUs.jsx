      ...
      <div className="container mx-auto px-6 lg:px-12 xl:px-20 relative z-10">
        <div className="flex flex-col md:flex-row items-center gap-12 md:gap-16">
          ...
          <div className="flex-1 relative">
            ...
            <Link
              to="/contact"
              className="inline-block text-white px-6 py-3 rounded-lg font-semibold transition-all duration-300 shadow-md hover:shadow-lg transform hover:-translate-y-1 btn btn-primary hover:bg-green-500 cursor-pointer relative overflow-hidden"
            >
