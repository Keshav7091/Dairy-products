    ...
    <div className="bg-gray-50 py-15">
      ...
      <div className="max-w-6xl container p-8 md:p-16 rounded-3xl ">
        ...
        <p className="text-gray-700 mb-6 text-center">
          At the heart of our dairy business is a simple belief: great food should do good—for your health, for the planet, and for the people who help produce it.
        </p>
        ...
        <div className="space-y-6">
          <div>
            ...
            <p className="text-gray-700 mb-2">
              All our milk comes from cows raised on farms across the UK. This means:
            </p>
            <ul className="list-disc list-inside text-gray-700 space-y-1">
              <li>Fewer food miles: No long-haul transport or imported ingredients</li>
              <li>Fresher product: From farm to facility within hours</li>
              <li>Stronger local economy: We pay fair rates to UK dairy farmers</li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="list-disc list-inside text-gray-700 space-y-1">
              <li>Made in the UK, reducing refrigeration needs and packaging waste</li>
              <li>Delivered fresh, not deep-frozen</li>
              <li>Produced in specially curated batches, lowering energy use and preventing excess inventory</li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="list-disc list-inside text-gray-700 space-y-1">
              ...
              <li>Packaging is recyclable, exploring fully compostable options</li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="list-disc list-inside text-gray-700 space-y-1">
              ...
              <li>Build a direct farmer-network model to improve traceability</li>
              <li>Support educational campaigns about real, traditional dairy vs. ultra-processed products</li>
            </ul>
          </div>

          <div>
            <p className="text-gray-700 text-lg font-medium">
              We don’t claim to be a climate solution—but we are committed to being a better food business. By working with local farmers, producing mindfully, and reducing food miles, we’re building something sustainable—not just for the environment, but for the people and traditions behind every product.
            </p>
          </div>
        </div>
      </div>
      ...
      <section className="space-y-24 max-w-7xl mx-auto px-6 md:px-20 py-16">
        {/* Section 1 - Production */}
        <div className="relative flex flex-col md:flex-row items-center md:gap-16">
              ...
              <div className="flex flex-wrap gap-4 mt-6">
                {["Fresh Milk", "Small Batches", "High Quality"].map(
                  (item, i) => (
                    <div
                      key={i}
                      className="bg-green-50 text-green-800 p-3 rounded-xl shadow hover:shadow-lg transition"
                    >
                      {item}
                    </div>
                  )
          ...
          <div className="md:w-1/2 mt-8 md:mt-0">
            ...
            <div className="grid grid-cols-2 gap-4 mt-4">
              {[
                ...
                <div
                  key={i}
                  className="bg-white p-4 rounded-xl shadow hover:shadow-lg text-gray-700"
                >
                  {item}
                </div>
              ))}
